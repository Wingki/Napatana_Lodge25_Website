...
const testimonialsData = [
  {
    quote: "Absolutely breathtaking! The views from our bungalow were postcard-perfect. The staff treated us like family. We can't wait to come back.",
    name: 'Jessica & Tom',
    location: 'Sydney, Australia',
  },
  {
    quote: "A true gem in Papua New Guinea. The food was incredible, especially the fresh seafood. Diving here is a must-do. Napatana Lodge exceeded all our expectations.",
    name: 'David L.',
    location: 'California, USA',
  },
  {
    quote: "We were looking for a peaceful escape, and we found it. Waking up to the sound of the ocean was magical. Thank you for an unforgettable stay.",
    name: 'Anja K.',
